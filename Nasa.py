#!/usr/bin/python3
#-*-coding:utf-8-*-
# Created By Shanto Ahmed 
# Thanks To Rongbaaz Tm 
...
\033[1;92m    *@@@***@@m                                  m@@                                        @@@**@@**@@@                  
\033[1;92m  @@   *@@m                                  @@                                        @*   @@   *@                  
 \033[1;92m @@   m@@    m@@*@@m *@@@@@@@@m   m@*@@@@@  @@m@@@@m   m@*@@m   m@*@@m   @***@@@           @@     *@@@@@@@@m@@@@@m  
\033[1;92m  !@@@@@@    @@*   *@@  @@    @@  m@@  @@    @@    *@@ @@   @@  @@   @@   *  @@@            !@       @@    @@    @@  
\033[1;92m  !@  @@m    @@     @@  @!    @@  *!!@@@*    !@     @@  m@@@!@   m@@@!@     @@!             !@       !@    @@    @@  
\033[1;92m  !@   *!@   @@     !@  @!    !@  @!         !!!   m@! @!   !@  @!   !@    !@@              !@       !@    !@    @@  
\033[1;92m  !@  ! !!   !@     !!  !!    !!  *!!!!!*    !!     !!  !!!!:!   !!!!:!    !@!              !@       !!    !!    !!  
...
\033[1;95m (__| |______________________________________________________| |__) 
\033[1;96m(__| |______________________________________________________| |__)
          C.E.O : FAYSAL BILLAL MIR | C.O " C.E.O EMON HASAN
          SENIOR ADMID: MUKTER HOSSAIN 
          MAMUN AHMED | ARIYAN AHMED 
          ADMIN : TUHIN AHMED | SALMAN AHMED 
          AHMED SAIDUL KHAN | SABBIR AHMED 
          MD : ASHRAFUL HOQUE | MD: AKASH MATUBBER 
\033[1;92mSAHANTO AHMED, 
\033[1;96m ( __| |_____________________________________________________| |__)
\033[1;95m ( __| |_____________________________________________________| |__)""")
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					print(("   %s"%e))
					continue
				print((k+"["+p+"•"+k+"]"+p+" Example : 786786,223344,102030"))
				self.pwlist()
				break
			elif f=="d":
				try:
...
def results(Shanto,Ahmed):
        if len(Shanto) !=0:
                print(("[OK] : "+str(len(Shanto))))
        if len(Shanto) !=0:
                print(("[CP] : "+str(len(Shanto))))
        if len(Shanto) ==0 and len(Shanto) ==0:
                print("\n")
...
def wangsaff():
    ...
    banner()
    input("\n[ Contact Our fb page? ]")
    jalan(k+"["+p+"•"+k+"]"+p+" Open FB page...")
    os.system("xdg-open https://www.facebook.com/100466858653425?text=Assalamualaikum%20shanto,%20shanto%20shanto%20SC%20SBF%20shanto.%20Code:%20404")
    input(k+"\n[ "+p+"Back"+k+" ]"+p)
    menu()
